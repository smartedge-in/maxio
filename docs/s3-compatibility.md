...
- Because Axum matches routes on the raw URI, handlers read [`VirtualHostContext`](../crates/maxio-server/src/api/virtual_host.rs) (set by middleware) to resolve the real bucket and object key.
